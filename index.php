   ...
   <div class="content">
        ...
        if (isset($_SESSION['email'])){
            ...
            <div class="note-body">
                <div class="form-group">
                    <input type="hidden" id="tid" name="tid" class="form-control" value="<?php echo $id?>"/>
                </div>
                <div class="form-group mt-2">
                    <label for="title" class="form-label"><input type="text" id="title" name="title" class="form-control" placeholder="Title:" value="<?php echo $row['title']?>" required/></label>
                </div>
                
                <div class="form-group">
                        <label for="Task" class="form-label"></label>
                        <input class="form-control" id="task" name="task" rows="2" placeholder="Task" value="<?php echo $row['task']?>" required></textarea>
                </div>

                <div class="form-group">
                    <label for="date" class="form-label"></label>
                        <div class="input-group date" id="deadline" >
                            <input type="text" name="deadline" class="form-control" placeholder="Deadline" value="<?php echo $row['deadline']?>"  required>
        ...
        <div class="note">
            <form action="include/add_script.php" method="post">
                ...
                <div class="note-body">
                    <div class="form-group mt-2">
                        <label for="title" class="form-label"><input type="text" id="title" name="title" class="form-control" placeholder="Title:" required/></label>
                    </div>
                    
                    <div class="form-group">
                            <label for="Task" class="form-label"></label>
                            <textarea class="form-control" id="task" name="task" rows="2" placeholder="Task" required></textarea>
                    </div>
        ...
        <div class="note">
            ...
            <div class="note-action">
                ...
                <div class="status"><button type="button" name="status" class="btn btn-success" >
                ...
                <div class="delete"><button type="button" class="btn btn-danger">
